...
public class TokenProviderImpl implements TokenProvider {
    ...
    @Override
    public Map<String, String> generateTokens(String requestUrl, UserDetails user) {
    ...
    public Map<String, String> regenerateAccessTokenIfRefreshTokenIsValid(String refreshToken, String requestUrl) {
        try {
            ...
            var username = decoderJWT.getSubject();
            var user = new UserDetails(repository.findUserByEmail(username)
    ...
    private String generateRefreshToken(String requestUrl, UserDetails user) {
    ...
    private String generateAccessToken(String requestUrl, UserDetails user) {
        var instant = Instant.now();
        return JWT.create().withSubject(user.getUsername())
